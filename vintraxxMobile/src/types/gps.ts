...
export interface GpsTerminal {
  ...
  /**
   * Optional 15-digit IMEI metadata (only populated for devices that send
   * the 2019-spec 0x0102 auth body, or were provisioned with one). Never
   * the gateway lookup key — see `deviceIdentifier`.
   */
  imei: string | null;
