...
import { api, Scan, ScanDetail, Appraisal, AppraisalDetail, ServiceAppointment, normalizePdfUrl } from '@/lib/api';
...
import {
  Search, Trash2, Eye, History, RefreshCw, ChevronLeft, ChevronRight, ExternalLink, FileText, ClipboardList, CalendarDays, CheckCircle, Mail, Send, X
} from 'lucide-react';
