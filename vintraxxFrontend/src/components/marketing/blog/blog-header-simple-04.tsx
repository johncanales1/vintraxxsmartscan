...
export const BlogHeaderSimple04 = () => {
    ...
    return (
        <div className="bg-primary">
            <section className="bg-brand-section py-16 md:py-24">
                <div className="mx-auto max-w-container px-4 md:px-8">
                    <div className="mx-auto flex w-full max-w-3xl flex-col items-center text-center">
                        <span className="text-sm font-semibold text-secondary_on-brand md:text-md">Resources</span>
                        <h2 className="mt-3 text-display-md font-semibold text-primary_on-brand md:text-display-lg">Untitled blog</h2>
                        ...
                        >
                            <div className="flex flex-col gap-1.5">
                                ...
                                <span className="self-start text-sm text-secondary_on-brand">
            ...
            <main className="mx-auto flex w-full max-w-container flex-col gap-12 px-4 py-16 md:px-8 md:py-24 lg:gap-16">
