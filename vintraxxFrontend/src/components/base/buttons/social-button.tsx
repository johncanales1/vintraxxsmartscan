...
interface CommonProps {
    social: "google" | "facebook" | "apple" | "twitter" | "figma" | "dribble" | "microsoft";
    disabled?: boolean;
    ...
    return (
        ...
        >
            <Logo
                ...
                colorful={
                    (theme === "brand" && (social === "google" || social === "figma" || social === "microsoft")) ||
                    (theme === "color" && (social === "google" || social === "facebook" || social === "figma" || social === "dribble" || social === "microsoft")) ||
                    undefined
                }
            />
